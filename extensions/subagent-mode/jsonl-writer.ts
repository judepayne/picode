/**
 * Backpressure-aware append-only JSONL writer.
 * Ported verbatim from agent/extensions/pi-subagents/jsonl-writer.ts —
 * the abstraction is sound and worth preserving.
 */
	...
	return {
		writeLine(line: string) {
			...
			try {
				...
				// Best-effort write; dropped lines do not abort the run.
			}
		},
		async close() {
