 ...
 *
 *   runChildInProcess(request, callbacks) → DelegatedChildResult
 *
...
export interface RunChildOptions {
	...
	sessionDir?: string;
	/** Forward transcript-grade events to the callback instead of keeping them data-plane only. */
...
export async function runChildInProcess(
