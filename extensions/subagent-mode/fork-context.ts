/**
 * Session branching for `context: "fork"` delegation.
 * Ported verbatim from pi-subagents/fork-context.ts — the abstraction is
 * the right shape and cross-compatible with pi's session manager.
 */
